# HW 10, Problems 1, 2, 3, and 4

# imports, requires newest version of SupportLib MarkovModel to be loaded in content root and  Anaconda to be installed locally and chosen as the interpreter
...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        # if DEATH will occur
        if next_state in [HealthStats.DEATH] and current_state in [HealthStats.POSTSTROKE]:
        ...
        self._totalDiscountedCost += \
            Econ.pv(cost, self._param.get_adj_discount_rate() / 2, 2*k + 1)
        self._totalDiscountedUtility += \
            Econ.pv(utility, self._param.get_adj_discount_rate() / 2, 2*k + 1)
...
def report_CEA(simOutputs_mono, simOutputs_combo):
    ...
    # show the CE plane
    CEA.show_CE_plane(
        title='Problem 3: Cost-Effectiveness Analysis',
...
COST_ANTICOAG = 2000 # annual cost of anticoag treatment
COST_NONE = 0
...
print("Problem 2:")
print("")
print_comparative_outcomes(notreatmentOutputs, treatmentOutputs)
print("")

# Problem 3
# report the CEA results
print("Problem 3:")
report_CEA(notreatmentOutputs, treatmentOutputs)
print("Cost-utility analysis table output as a CSV file entitled 'CETable.csv' within the directory where this script is being run.")
print("")

# Problem 4
# report CBA results
print("Problem 4:")
report_CBA(notreatmentOutputs, treatmentOutputs)
print("I would recommend adoption of this anticoagulation drug at a willingness-to-pay level of approximately $9000 for one additional QALY.")
